...
# 
# Consider the following elements, noting that $a$ is the standard $2\text{B}$-involution in mmgroup, i.e. the center of the distinghuised $2\text{B}$-centraliser $\mathbf{G} \cong 2^{1+24}.\text{Co}_1$.
