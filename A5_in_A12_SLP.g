...
#
# This code can be used the verify a part of the proof of Proposition 4.2.
# Specifically, it shows that the group A_B constructed in Proposition 4.2 is an A5 of type "B".
#
# The functions A5_in_A12_gen_1 and A5_in_A12_gen_2 are SLPs that take generators 
# for A12 satisfying the presentation in the proof of Proposition 4.1, and output generators 
...
# Commands for verifying the claims made in the proof of Proposition 4.2 are given below the function definitions.
#
